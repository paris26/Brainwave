      ...
      <div className='container relative' ref={parallaxRef}>
        <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]'>
            <h1 className='h1 mb-6'> Explore the Possibilities of AI Chatting with {" "} 
                <span className='h1 inline-block relative '> Brainwave{" "} <img className='absolute top-fuil left-0 w-full xl:-mt-2 ' width={624} height={128} src={curve} alt="Curve" /> </span>
            </h1>
        ...
        <div className='mx-auto max-w-[23rem] relative md:max-w-5xl xl:mb-22'>
            <div className='relative z-1 p-05 rounded-2xl bg-conic-gradient '>
                <div className='relative rounded-[1rem] bg-n-8 '>
                    <div className='h-[1.4rem] bg-n-10 rounded-t-[0.9rem]'/>

                    <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:apect-[1024/90]'>
                        ...
                        <ScrollParallax isAbsolutelyPositioned>
                                <Notification 
                                    className="hidden absolute -right-[5.5rem] bottom-[11rem] xl:flex"
            ...
            <div className='absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:2-[138%] '>
                <img 
                    src={heroBackground}
                    className="w-full"
                    width={1440} 
