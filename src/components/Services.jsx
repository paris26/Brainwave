            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                ...
                <div className="relative z-1 grid gap-5 lg:grid-cols-2 ">
                    ...
                    <div className="border border-n-1/10 relative min-h-[39rem] rounded-3xl overflow-hidden">
                        ...
                        {/* heading and a p element */}
                        <div className="flex flex-col absolute  inset-0 justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15">
                    ...
                    <div className="bg-n-7 p-4 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                        ...
                        {/* chat message and image (separate divs)*/}
